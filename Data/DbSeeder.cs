        ...
        public static async Task SeedEmployersAsync(AppDbContext context)
        {
                ...
                var employers = new List<Employers>
            {
                new Employers
                {
                    ...
                    LogoURL = "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/FPT_logo_vn.svg/1200px-FPT_logo_vn.svg.png",
                    CityId = 16, // Hà Nội
                ...
                new Employers
                {
                    ...
                    LogoURL = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/VINGROUP_LOGO.svg/2560px-VINGROUP_LOGO.svg.png",
                    CityId = 18, // Hải Phòng
                ...
                new Employers
                {
                    ...
                    LogoURL = "https://upload.wikimedia.org/wikipedia/vi/thumb/9/9e/Viettel_logo.svg/1200px-Viettel_logo.svg.png",
                    CityId = 16, // Hà Nội
                ...
                new Employers
                {
                    ...
                    LogoURL = "https://static.techcombank.com.vn/TCB%20Portal/eBanking/images/TCB-logo.svg",
                    CityId = 19, // Hưng Yên
                ...
                new Employers
                {
                    ...
                    LogoURL = "https://upload.wikimedia.org/wikipedia/vi/thumb/e/e1/VNPT_Logo_2006.svg/1200px-VNPT_Logo_2006.svg.png",
                    CityId = 16, // Hà Nội
        ...
        public static async Task SeedPostsAsync(AppDbContext context)
        {
                ...
                List<Post> posts = new List<Post>()
            {
                 ...
                 new Post
                {
                    ...
                    Description = "Tuyển nhân viên Marketing Online có kinh nghiệm chạy quảng cáo Facebook, Google Ads.",
                    Benefits = """
                ...
                new Post
                {
                    ...
                    Description = "Công ty Bất động sản cần tuyển nhân viên kinh doanh có kinh nghiệm, đam mê với lĩnh vực bất động sản.",
                    Benefits = """
                ...
                new Post
                {
                    ...
                    Description = "Công ty cần tuyển Trợ lý Giám đốc, có kinh nghiệm làm việc với lãnh đạo cấp cao.",
                    Benefits = """
                ...
                new Post
                {
                    ...
                    Description = "Công ty Thương mại tuyển Nhân viên Xuất nhập khẩu, có kinh nghiệm làm thủ tục hải quan.",
                    Benefits = """
                ...
                {
                    Title = "Kiến trúc sư",
                    Description = "Văn phòng Kiến trúc tuyển Kiến trúc sư, có kinh nghiệm thiết kế nhà phố, biệt thự.",
                    Benefits = """
